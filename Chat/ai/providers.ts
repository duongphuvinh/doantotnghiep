...
export const modelDetails: Record<keyof typeof languageModels, ModelInfo> = {
  ...
  //   capabilities: ["Reasoning", "Efficient", "Agentic"]
  // },
  "gemini-2.5-flash": {    provider: "google",    name: "gemini-2.5-flash",    description: "Compact version of gemini-2.5-flash with good balance of capabilities, including vision.",    apiVersion: "gemini-2.5-flash",    capabilities: ["Balance", "Creative", "Vision"]  }
};
